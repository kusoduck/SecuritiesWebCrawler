...
public enum InvestorsDailyTradingHeader {
	SECURITY_CODE("證券代號"),
	SECURITY_NAME("證券名稱"),
	...
	InvestorsDailyTradingHeader(String zhTitle) {
		setZhTitle(zhTitle);
	}

	public static InvestorsDailyTradingHeader getByZhTitle(String value) {
		if (value != null) {
			String realValue = value.trim();
			if (!realValue.isEmpty()) {
				for (InvestorsDailyTradingHeader key : values()) {
