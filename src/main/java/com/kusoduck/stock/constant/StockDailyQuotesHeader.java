...
public enum StockDailyQuotesHeader {
	SECURITY_CODE("證券代號"),
	SECURITY_NAME("證券名稱"),
	TRADE_VOLUME("成交股數"),
	TRANSACTION("成交筆數"),
	...
	StockDailyQuotesHeader(String zhTitle) {
	...
	public static StockDailyQuotesHeader getByZhTitle(String value) {
		if (value != null) {
			String realValue = value.trim();
			if (!realValue.isEmpty()) {
				for (StockDailyQuotesHeader key : values()) {
